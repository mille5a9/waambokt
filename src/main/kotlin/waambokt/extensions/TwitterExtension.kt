...
class TwitterExtension : Extension() {
    ...
    override suspend fun setup() {
        event<MessageCreateEvent> {
            action {
                ...
                event.message.reply { embed { title = notesHead; description = result.texts.joinToString { "\n" } } }
            }
        }
    }
    ...
    companion object {
        ...
        private const val notesHead = "Readers added context they thought people might want to know"
